...
Funded account traders often focus on profit targets, but a [trading discipline](/blogs/trading-discipline-prop-firm) process score can be more useful during review. One simple method is to score each trade as either compliant or non-compliant with your written rules.
...
These are process experiments, not promises of profit. A [P&L calendar](/blogs/prop-firm-pnl-calendar) can make these weekly patterns even easier to see at a glance.
