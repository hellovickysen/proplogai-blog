...
A [trading journal](/blogs/prop-firm-trading-journal) can make this easier to see. Track the number of trades per day, the first trade result, emotional tags, and whether each trade matched the planned setup. Over time, the trader can review whether trade count increases after specific outcomes.
